...
We are excited to announce the release of version [master](https://github.com/krayin/laravel-crm) of Krayin, which includes numerous enhancements and improvements. To ensure a smooth transition to this latest version.
